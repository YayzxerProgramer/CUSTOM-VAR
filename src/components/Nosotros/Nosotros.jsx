...
const ciudades = [
    {
        ...
        ciudad: "Cartagena",
        region: "Caribe",
        rol: "Sede principal de la operación nacional V.A.R. con planta de producción Ducteria.",
        anos: "Por confirmar",
        tr: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Bogotá",
        region: "Centro",
        rol: "Centro de distribución V.A.R. para el centro y norte del país con planta de producción Ducteria.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Cali",
        region: "Pacífico",
        rol: "Centro de distribución para el suroccidente colombiano.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Barranquilla",
        region: "Caribe",
        rol: "Sede Inhouse con servicios permanentes de HVAC y desarrollo de proyectos con entidades de servicios públicos e infraestructura energética.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Medellín",
        region: "Antioquia",
        rol: "Desarrollo de proyectos gubernamentales.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Quindío",
        region: "Eje Cafetero",
        rol: "Ejecución de proyectos en institucionales y gubernamentales.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Cundinamarca",
        region: "Centro",
        rol: "Participación en proyectos empresariales, farmacéuticos e institucionales.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Turbo",
        region: "Antioquia",
        rol: "Implementación de proyectos para infraestructura marítima estratégica.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
    ...
    },
    {
        ...
        ciudad: "Popayán",
        region: "Cauca",
        rol: "Ejecución de proyectos para infraestructura aeroportuaria.",
        anos: "Por confirmar",
        tr: "Por confirmar",
        clientes: "Por confirmar",
        proyectos: "Por confirmar",
            ...
            <div className="nosotros-container">
                ...
                <section className="map-section" aria-label="Presencia nacional">
                    <div className="map-section__copy">
                        ...
                        <p>
                            Seleccione una ubicación en el mapa para conocer nuestra presencia regional,
                            años de experiencia, TR instaladas, clientes atendidos y proyectos ejecutados.
                        </p>

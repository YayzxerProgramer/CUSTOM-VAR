...
export default function BotonWhatsApp() {
    ...
    return (
        <div className="contenedor-whatsapp-flotante">
            {mostrarMensaje && (
                <div className="bocadillo-whatsapp">
                    <button
                        className="boton-cerrar-bocadillo"
                        onClick={() => setMostrarMensaje(false)}
                        aria-label="Cerrar mensaje"
                    >
                        &times;
                    </button>
                    <p className="texto-bocadillo">
                        ¿Necesitas asesoría? <strong>Contáctanos aquí</strong>
                    </p>
                    <div className="flecha-bocadillo"></div>
                </div>
            )}

            <a
                href={urlWhatsApp}
                className="enlace-whatsapp-icono"
                target="_blank"

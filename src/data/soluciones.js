...
export const proyectos = [
    {
        id: 'bim',
        icono: 'architecture',
        titulo: 'Diseno e Ingenieria VAR con Modelado BIM',
        imagen: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Mitigamos los riesgos de construccion antes de colocar el primer tornillo. Desarrollamos ingenieria conceptual, basica y de detalle integrando modelado BIM para prever interferencias y asegurar la viabilidad tecnica.',
    },
    {
        id: 'infraestructura-critica',
        icono: 'dns',
        titulo: 'Soluciones de Climatizacion para Infraestructura Critica',
        imagen: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Protegemos la continuidad donde el fallo no es una opcion. Disenamos aire acondicionado de precision y ventilacion para centros de datos, hospitales y laboratorios con redundancia y control exacto.',
    },
    {
        id: 'bms',
        icono: 'monitoring',
        titulo: 'Automatizacion y Control Inteligente (Sistemas BMS)',
        imagen: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Integramos sistemas BMS que monitorean y regulan la climatizacion segun ocupacion y condiciones exteriores, reduciendo error humano y consumo electrico diario.',
    },
    {
        id: 'commissioning',
        icono: 'fact_check',
        titulo: 'Comisionamiento y Validacion de Sistemas',
        imagen: 'https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Validamos que el balanceo de aire, agua y controles automatizados funcionen segun el diseno original, garantizando eficiencia desde el primer dia.',
    },
    {
        id: 'retrofitting-proyectos',
        icono: 'autorenew',
        titulo: 'Conversion y Modernizacion Tecnologica (Retrofitting)',
        imagen: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Renovamos infraestructura obsoleta sustituyendo componentes clave por tecnologia inverter, refrigerantes ecologicos o chillers de nueva generacion.',
    },
    {
        id: 'cadena-frio-industrial',
        icono: 'ac_unit',
        titulo: 'Gestion de Cadena de Frio y Refrigeracion Industrial',
        imagen: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1200&auto=format&fit=crop',
        descripcion: 'Disenamos sistemas frigorificos para CEDIS, andenes y camaras de congelacion, con monitoreo termico continuo para mitigar riesgos de merma.',
    },
];
